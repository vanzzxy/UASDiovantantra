...
<body>
    <div class="container">
        ...
        <h3 class="text-center">PEMESANAN TIKET FILM</h3>
            ...
            <div class="card-body">
                ...
                <table class="table table-striped table-hover table-bordered">
                    ...
                    <tr>
                        ...
                        <td><?= $data['ttanggal'] ?></td>
                        <td>
                            <a href="crud.php?hal=edit&id=<?=$data['id']?>" class="btn btn-warning">Edit</a>

                            <a href="crud.php?hal=hapus&id=<?=$data['id']?>" class="btn btn-danger" 
